...
public class DrawMonst {
    ...
    public void guiño(GL gl, GLU glu){
         set_black_material(gl);
         gl.glPushMatrix();
...
//        gl.glRotatef(60f, 1f, 0.0f, 0f);
     ...
     public void arm_left_ap2 (GL gl, GLU glu){        //arm_left_ap1
        //we create left arm
...
//    }
     ...
     public void set_pink_material (GL gl){
        float[] mat_ambient ={ 0.9f,0.5f,0.5f,0.5f };
        float[] mat_diffuse ={ 0.6f,0.4f,0.4f,1.0f};
        float[] mat_specular ={0.9f,0.6f,0.6f,1.0f };
        float shine=125.2f;
        gl.glMaterialfv(GL.GL_FRONT_AND_BACK,GL.GL_AMBIENT,mat_ambient, 0);
        gl.glMaterialfv(GL.GL_FRONT_AND_BACK,GL.GL_DIFFUSE,mat_diffuse,0);
        gl.glMaterialfv(GL.GL_FRONT_AND_BACK,GL.GL_SPECULAR,mat_specular,0);
     ...
     public void set_horns_material (GL gl){
        ...
        float[] mat_ambient ={ 0.5f,0.5f,0.5f,0.2f };
        float[] mat_diffuse ={ 0.4f,0.4f,0.4f,1.0f};
        float[] mat_specular ={0.7f,0.6f,0.6f,1.0f };
        float shine =15.0f ;
...
//    }
    public void set_armleg_material (GL gl){
        ...
        float[] mat_ambient ={ 0.2f,0.5f,0.5f,0.2f };
        float[] mat_diffuse ={ 0.6f,0.4f,0.4f,1.0f};
        float[] mat_specular ={0.9f,0.6f,0.6f,1.0f };
        float shine=125.2f;
